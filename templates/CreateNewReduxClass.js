...
const mapStateToProps = (state) => {
    /**
     * map reducers states to props
     */
    return {
        /**
         *  propsName: state.{reducer name}.{any state as defined in initial state inside reducer}
         *          - it can be access by calling {this.props.propName}
         *          - ex:   places: state.placeReducer.places
         */
...
const mapDispatchToProps = (dispatch) => {
    /**
     * map actions functions to props
     * note that action file contains addPlaces
     */
    return {
        /**
         *  functionName: (optional payload) = {
         *      dispatch(actionFunction(optional payload))
         *  }
         *
         *  OR
         *
